...
export const navbarCourseSlugsByLang: Record<string, string[]> = {
  tr: [
    ...
    'online-kurslar-genel-bakis', 'online-almanca', 'online-yogun-a1', 'online-yogun-a2', 'online-yogun-b1', 'online-yogun-b2', 'online-yogun-c1', 'online-sinav-hazirlik',
  ...
  de: [
    ...
    'online-uebersicht', 'online-deutsch', 'online-intensiv-a1', 'online-intensiv-a2', 'online-intensiv-b1', 'online-intensiv-b2', 'online-intensiv-c1', 'online-pruefungsvorbereitung',
  ...
  en: [
    ...
    'online-overview', 'online-german', 'online-intensive-a1', 'online-intensive-a2', 'online-intensive-b1', 'online-intensive-b2', 'online-intensive-c1', 'online-exam-preparation',
  ...
  es: [
    ...
    'resumen-online', 'aleman-online', 'intensivo-online-a1', 'intensivo-online-a2', 'intensivo-online-b1', 'intensivo-online-b2', 'intensivo-online-c1', 'preparacion-examenes-online',
