...
**Standort Bremen Campus German Sprachschule**  
- Adresse: Bürgermeister-Smidt-Str. 80, 28195 Bremen  
- E-Mail: bremen@campusgerman.com  

**Standort Dortmund Campus German Sprachschule**  
- Adresse: Florianstr. 15-21 44139 Dortmund  
- E-Mail: dortmund@campusgerman.com  
...
- Stockfotos: Lizenziertes Bildmaterial von Canva (www.canva.com) und Envato Elements (elements.envato.com).  
- KI-Inhalte: Grafiken und Textinhalte, die unter Unterstützung von OpenAI (ChatGPT) und Google (Gemini) erstellt wurden.  
- Akademische Grafiken: Darstellungen zum Gemeinsamen Europäischen Referenzrahmen (GER/CEFR).  
