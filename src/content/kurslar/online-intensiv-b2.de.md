...
badge:
  icon: "fas fa-laptop"
  text: "Online B2"
description: "Schließen Sie online das Niveau B2 ab. Entwickeln Sie Ihre fortgeschrittenen Deutschkenntnisse mit Live-Unterricht."
    ...
    content:
      ...
      paragraphs:
        - heading: "Kursüberblick"
          text: "Der Online Intensiv-Deutschkurs B2 ist ein umfassendes Online-Programm für Lernende, die das Niveau B1 abgeschlossen haben und ihre Deutschkenntnisse auf fortgeschrittenem Mittelstufenniveau weiterentwickeln möchten. Ziel des Kurses ist es, die Teilnehmenden sprachlich auf eine professionelle Kommunikation im Berufsleben sowie auf akademische Anforderungen vorzubereiten. Der Kurs umfasst 20 Unterrichtseinheiten pro Woche, dauert 12 Wochen und besteht aus insgesamt ca. 200 Unterrichtseinheiten."
        - heading: "Vorteile des Online-Unterrichts"
          text: "Das Online-Format bietet maximale zeitliche und räumliche Flexibilität. Sie können von zu Hause oder von jedem beliebigen Ort aus am Unterricht teilnehmen und hochwertige Bildung ohne Reiseaufwand erhalten. Alle Unterrichtseinheiten werden aufgezeichnet und stehen Ihnen rund um die Uhr zur Verfügung, sodass Sie Inhalte wiederholen oder verpasste Stunden nachholen können. Digitale Materialien und interaktive Übungen unterstützen einen nachhaltigen Lernerfolg."
        - heading: "Zielgruppe und Voraussetzungen"
          text: "Der Kurs richtet sich an Lernende, die das Niveau B1 erfolgreich abgeschlossen haben. Das B2-Niveau stellt eine entscheidende Stufe dar, da Lernende auf diesem Niveau komplexe Texte verstehen und sich zu abstrakten Themen fließend äußern können. Der Kurs eignet sich für Studieninteressierte in Deutschland, Berufstätige mit hohen sprachlichen Anforderungen sowie für Personen, die akademisch oder beruflich auf Deutsch arbeiten möchten. Voraussetzung ist eine stabile Internetverbindung sowie ein Computer oder Tablet."
        - heading: "Kursinhalte und Lernziele"
          text: "Auf dem Niveau B2 lernen die Teilnehmenden, die Hauptinhalte anspruchsvoller Texte zu verstehen und sich spontan sowie differenziert zu konkreten und abstrakten Themen zu äußern. Im Kurs werden komplexe Grammatikstrukturen, ein erweitertes akademisches und berufliches Vokabular sowie professionelle Kommunikationsstrategien vermittelt. In den Live-Stunden üben die Teilnehmenden, Argumente klar darzustellen, an Diskussionen aktiv teilzunehmen sowie akademische Texte zu lesen und zu verfassen. Thematische Schwerpunkte sind unter anderem Beruf, Politik, Kultur und Wissenschaft."
        - heading: "Unterrichtsmethode und technischer Support"
          text: "Der Unterricht findet live über Zoom oder vergleichbare Plattformen statt. Jede Klasse besteht aus maximal 10 Teilnehmenden und wird von zwei Lehrkräften betreut, um eine individuelle Förderung zu gewährleisten. Der Kurs ist praxis- und akademikorientiert aufgebaut und beinhaltet Textanalysen, Diskussionsrunden, Präsentationen, Schreibübungen und Aufgaben zum kritischen Denken. Die Teilnehmenden entwickeln neben sprachlichen Fähigkeiten auch akademische und professionelle Kompetenzen. Unser technisches Support-Team steht Ihnen bei technischen Fragen jederzeit zur Verfügung."
faqs:
  - question: "Ist das Niveau B2 für ein Studium ausreichend?"
    answer: "B2 kann für einige Studiengänge ausreichend sein, jedoch verlangen die meisten Hochschulen das Niveau C1 oder den Nachweis durch Prüfungen wie TestDaF oder DSH."
  - question: "Gibt es akademisches Schreiben im Online-Unterricht?"
    answer: "Ja. Auf dem Niveau B2 werden akademisches Schreiben, Textanalyse sowie professionelle mündliche Kommunikation intensiv trainiert."
