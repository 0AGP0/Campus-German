...
tabs:
    ...
    content:
      ...
      paragraphs:
        - heading: "Kursa Genel Bakış"
          text: "Goethe/TELC A1 Hazırlık Kursu, Goethe ve TELC A1 sınavlarına hazırlanmak isteyen öğrenciler için tasarlanmış, sınav odaklı kapsamlı bir programdır. Bu kurs, öğrencilerin A1 sınav formatına özel hazırlık yapmalarını, sınav tekniklerini öğrenmelerini ve başarılı olmalarını sağlamayı hedefler. Haftada 20 ders saati ile yoğun bir hazırlık deneyimi sunan program, 4 hafta sürmektedir ve yaklaşık 80 ders saatinden oluşmaktadır."
        - heading: "Hedef Sınavlar ve Ön Koşullar"
          text: "Bu kurs, Goethe A1 ve TELC A1 sınavlarına hazırlık yapmaktadır. A1 seviyesini tamamlamış öğrenciler için uygundur. Goethe A1 sınavı, dünya çapında tanınan bir Almanca dil sertifikasıdır ve temel seviye Almanca bilgisini belgeler. TELC A1 sınavı ise Avrupa çapında yaygın olarak kullanılan bir dil sertifikasıdır ve özellikle göçmenlik başvuruları için önemlidir. Her iki sınav da A1 seviyesindeki dil becerilerini ölçer."
  ...
  - id: "sinav-bilgisi"
    ...
    content:
      title: "A1 Sınav İçeriği"
      items:
        - icon: "fas fa-check-circle"
          text: "<strong>Okuma:</strong> Basit metinleri anlama"
        - icon: "fas fa-check-circle"
          text: "<strong>Dinleme:</strong> Basit diyalogları anlama"
        - icon: "fas fa-check-circle"
          text: "<strong>Yazma:</strong> Basit metinler yazma"
        - icon: "fas fa-check-circle"
          text: "<strong>Konuşma:</strong> Basit konuşmalar yapma"
faqs:
  - question: "A1 seviyesini tamamlamadan sınav hazırlığına başlayabilir miyim?"
    answer: "Hayır, A1 sınav hazırlığı için A1 seviyesini tamamlamış olmanız gerekir."
  - question: "Sınav ücreti dahil mi?"
    answer: "Hayır, sınav ücreti ayrıdır. Ancak sınav başvurusu konusunda yardımcı oluyoruz."
