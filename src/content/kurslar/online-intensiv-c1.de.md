...
lang: "de"
customSlug: "online-intensiv-c1"
badge:
  icon: "fas fa-laptop"
  text: "Online C1"
description: "Schließen Sie online das Niveau C1 ab. Entwickeln Sie Ihre Deutschkenntnisse auf Universitätsniveau mit Live-Unterricht."
    ...
    content:
      ...
      paragraphs:
        ...
        - heading: "Zielgruppe und Voraussetzungen"
          text: "Der Kurs richtet sich an Lernende, die das Niveau B2 erfolgreich abgeschlossen haben. Das C1-Niveau stellt eine der höchsten Stufen im Spracherwerb dar, da Lernende auf diesem Niveau nahezu muttersprachliche Kommunikation erreichen können. Der Kurs eignet sich für Studieninteressierte in Deutschland, Personen, die akademische Forschung betreiben möchten, Berufstätige, die in Führungspositionen arbeiten möchten, sowie für alle, die in deutschsprachigen Ländern eine professionelle Karriere anstreben. Voraussetzung ist eine stabile Internetverbindung sowie ein Computer oder Tablet."
        - heading: "Kursinhalte und Lernziele"
          text: "Auf dem Niveau C1 lernen die Teilnehmenden, lange und komplexe Texte zu verstehen, implizite Bedeutungen zu erfassen und sich fließend und spontan auszudrücken. Im Kurs werden akademische Grammatikstrukturen, wissenschaftliches Vokabular, Forschungsschreibtechniken und professionelle Präsentationsfähigkeiten vermittelt. In den Live-Stunden lernen die Teilnehmenden, akademische Artikel zu verstehen, Forschungstexte zu verfassen, über komplexe Themen zu diskutieren und professionelle Präsentationen zu halten. Zusätzlich werden Sprachmittel zu Bereichen wie Wissenschaft, Technologie, Kunst und Philosophie gezielt trainiert."
        - heading: "Unterrichtsmethode und technischer Support"
          text: "Der Unterricht findet live über Zoom oder vergleichbare Plattformen statt. Jede Klasse besteht aus maximal 10 Teilnehmenden und wird von zwei Lehrkräften betreut, um eine individuelle Förderung zu gewährleisten. Der Kurs ist praxis- und akademikorientiert aufgebaut und beinhaltet Textanalysen, Forschungsprojekte, akademische Schreibübungen, Diskussionsrunden und Präsentationsarbeiten. Die Teilnehmenden entwickeln neben sprachlichen Fähigkeiten auch akademische und professionelle Kompetenzen. Unser technisches Support-Team steht Ihnen bei technischen Fragen jederzeit zur Verfügung."
faqs:
  - question: "Ist das Niveau C1 für ein Studium ausreichend?"
    answer: "Ja, das C1-Niveau ist für die meisten deutschen Universitäten ausreichend. Einige Universitäten können zusätzlich TestDaF oder DSH-Prüfungen verlangen."
  - question: "Wird akademisches Schreiben im Online-C1-Kurs unterrichtet?"
    answer: "Ja, auf dem Niveau C1 werden akademisches Schreiben, Forschungstexte und professionelle Präsentationstechniken unterrichtet."
