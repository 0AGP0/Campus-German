...
badge:
  icon: "fas fa-laptop"
  text: "Online"
description: "Evden rahatça Almanca öğrenin. Canlı dersler, interaktif materyaller ve esnek program seçenekleri."
image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2071&q=80"
features:
  - icon: "fas fa-laptop"
    title: "Format"
    description: "Online Canlı"
  - icon: "fas fa-clock"
    title: "Esnek Program"
  ...
  - icon: "fas fa-globe"
    title: "Erişim"
    description: "Dünyanın Her Yerinden"
heroButtons:
  primary:
    text: "Hemen Başvur"
...
tabs:
  - id: "kurs-bilgileri"
    ...
    content:
      title: "Online Kurslar Hakkında"
      items:
        - icon: "fas fa-laptop"
          text: "<strong>Format:</strong> Canlı online dersler"
        - icon: "fas fa-clock"
          text: "<strong>Esneklik:</strong> Esnek program seçenekleri"
        - icon: "fas fa-users"
          text: "<strong>Sınıf Mevcudu:</strong> Maks. 10 öğrenci"
        - icon: "fas fa-globe"
          text: "<strong>Erişim:</strong> Dünyanın her yerinden"
      additionalInfo:
        title: "Online Eğitim Avantajları"
        text: "Evden rahatça, canlı dersler ile Almanca öğrenin. Ders kayıtlarına 7/24 erişim ve interaktif materyaller."
  - id: "programlar"
    icon: "fas fa-list"
    title: "Programlar"
    content:
      title: "Online Program Seçenekleri"
      items:
        - icon: "fas fa-fire"
          text: "<strong>Yoğun Online:</strong> A1'den C1'e tüm seviyeler"
        - icon: "fas fa-certificate"
          text: "<strong>Sınav Hazırlık:</strong> Goethe/TELC online hazırlık"
faqs:
  - question: "Online dersler canlı mı?"
    answer: "Evet, tüm dersler canlı olarak yapılır ve ders kayıtlarına sonradan erişebilirsiniz."
  - question: "Hangi platform kullanılıyor?"
    answer: "Zoom veya benzeri profesyonel online eğitim platformları kullanılmaktadır."
