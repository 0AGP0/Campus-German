...
badge:
  icon: "fas fa-fire"
  text: "B2 Seviye"
description: "B1 seviyesini tamamlayanlar için yoğun B2 kursu. İleri seviye Almanca becerilerinizi geliştirin."
    ...
    content:
      ...
      paragraphs:
        ...
        - heading: "Kurs İçeriği ve Öğrenme Hedefleri"
          text: "B2 seviyesinde öğrenciler, karmaşık metinlerin ana fikirlerini anlayabilir, somut ve soyut konularda akıcı ve spontane bir şekilde konuşabilir hale gelirler. Kurs süresince karmaşık dilbilgisi yapıları, akademik kelime dağarcığı ve profesyonel iletişim becerileri öğretilir. Öğrenciler görüşlerini detaylı bir şekilde savunabilir, tartışmalara aktif olarak katılabilir, akademik metinleri anlayabilir ve yazabilir hale gelirler. Ayrıca iş hayatı, politika, kültür, bilim gibi konularda gerekli dil yapıları öğretilir."
        - heading: "Öğretim Metodu ve Sınıf Ortamı"
          text: "Kurs, iletişim odaklı bir yaklaşımla yürütülmektedir. Her sınıfta maksimum 12 öğrenci bulunur ve her sınıfın iki öğretmeni vardır. Bu sistem, öğrencilerin bireysel dil gelişimine odaklanmayı sağlar. Dersler, akademik metin analizleri, tartışma aktiviteleri, sunum çalışmaları, yazma alıştırmaları ve eleştirel düşünme aktiviteleri ile zenginleştirilmiştir. Öğrenciler sadece dilbilgisi öğrenmekle kalmaz, aynı zamanda akademik ve profesyonel becerilerini de geliştirirler."
        - heading: "Kurs Sonrası İlerleme"
          text: "B2 seviyesini başarıyla tamamlayan öğrenciler, B2 seviye sertifikası almaya hak kazanırlar. Bu sertifika, öğrencinin ileri orta seviyede Almanca bilgisine sahip olduğunu gösterir ve birçok üniversite ve iş başvurusu için yeterli kabul edilir. Kurs sonrasında öğrenciler C1 seviyesine geçiş yapabilir veya TestDaF, DSH gibi üniversite giriş sınavlarına hazırlanabilirler. B2 seviyesi, bağımsız ve akıcı dil kullanıcısı olmanın önemli bir aşamasıdır."
  - id: "dersler"
    icon: "fas fa-book-open"
    title: "Dersler"
    content:
      title: "B2 Seviyesi İçeriği"
      lessons:
        - title: "Profesyonel Almanca"
          description: "İş hayatında profesyonel seviye Almanca"
        - title: "Akademik Yazma"
          description: "Akademik metinler yazma ve analiz etme"
        - title: "Akıcı Konuşma"
          description: "Karmaşık konularda akıcı konuşma pratiği"
faqs:
  - question: "B2 seviyesi üniversite için yeterli mi?"
    answer: "B2 seviyesi bazı üniversiteler için yeterli olabilir, ancak çoğu üniversite C1 seviyesi veya TestDaF/DSH sınavı ister."
  - question: "B2 seviyesini tamamladıktan sonra ne yapabilirim?"
    answer: "B2 seviyesini tamamladıktan sonra C1 seviyesine geçiş yapabilir veya TestDaF/DSH sınavına hazırlanabilirsiniz."
