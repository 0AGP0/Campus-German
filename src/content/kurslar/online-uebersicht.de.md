---
title: "Überblick: Online-Deutschkursangebote"
lang: "de"
badge:
  icon: "fas fa-laptop"
  text: "Online"
description: "Lernen Sie Deutsch bequem von zu Hause aus. Live-Unterricht, interaktive Materialien und flexible Kursmodelle."
image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2071&q=80"
features:
  - icon: "fas fa-laptop"
    title: "Format"
    description: "Live-Online-Unterricht"
  - icon: "fas fa-clock"
    title: "Flexible Planung"
    description: "24/7 Zugriff"
  - icon: "fas fa-users"
    title: "Klassengröße"
...
tabs:
  - id: "kursinformationen"
    ...
    content:
      title: "Über die Online-Kurse"
      items:
        - icon: "fas fa-laptop"
          text: "<strong>Format:</strong> Live-Online-Unterricht"
        - icon: "fas fa-clock"
          text: "<strong>Flexibilität:</strong> Flexible Kursmodelle"
        - icon: "fas fa-users"
          text: "<strong>Klassengröße:</strong> Max. 10 Teilnehmende"
        - icon: "fas fa-globe"
          text: "<strong>Zugriff:</strong> Von überall auf der Welt"
      additionalInfo:
        title: "Vorteile des Online-Unterrichts"
        text: "Lernen Sie Deutsch bequem von zu Hause aus mit Live-Unterricht. 24/7 Zugriff auf Unterrichtsaufzeichnungen und interaktive Lernmaterialien."
  - id: "programme"
    icon: "fas fa-list"
    title: "Programme"
    content:
      title: "Online-Programmoptionen"
      items:
        - icon: "fas fa-fire"
          text: "<strong>Online-Intensiv:</strong> Alle Niveaustufen von A1 bis C1"
        - icon: "fas fa-certificate"
          text: "<strong>Prüfungsvorbereitung:</strong> Online-Vorbereitung für Goethe/telc"
faqs:
  - question: "Sind die Online-Kurse live?"
    answer: "Ja, alle Kurse finden live statt. Zusätzlich erhalten Sie Zugriff auf die Unterrichtsaufzeichnungen."
  - question: "Welche Plattform wird genutzt?"
    answer: "Es werden Zoom oder vergleichbare professionelle Online-Lernplattformen verwendet."
