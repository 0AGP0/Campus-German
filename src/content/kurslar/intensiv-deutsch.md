...
badge:
  icon: "fas fa-fire"
  text: "Yoğun Almanca"
description: "Almanya'da üniversite eğitimi veya kariyer hedeflerinize en kısa sürede ulaşın. Haftada 25 ders saati ile iletişim odaklı, akademik standartlarda ve hızlı ilerleme sağlayan bu program, Almanya'da sizi bekliyor. Vize başvuruları için uygundur."
  ...
  - id: "kurs-bilgileri"
    ...
    content:
      ...
      items:
        ...
        - icon: "fas fa-clock"
          text: "<strong>Haftalık Ders:</strong> 25 Ders Saati (Her ders 45 dk)"
        - icon: "fas fa-users"
...
faqs:
  - question: "Bu kurs vize başvurusu (Dil Okulu Vizesi) için uygun mu?"
    answer: "Evet, Yoğun Almanca kursumuz haftalık 20 saatin üzerindedir (25 Ders/Hafta). Bu yoğunluk, Almanya Öğrenci Vizesi veya Dil Kursu Vizesi başvuruları için konsoloslukların talep ettiği resmi şartları tam olarak karşılar. Kayıt sonrası size resmi kabul belgesi gönderiyoruz."
